...
handler.all = async function (m) {
	let pp = 'https://telegra.ph/file/ad28299e04d0b777a83ea.jpg'
	try {
        ...
        global.col = 'https://telegra.ph/file/ad28299e04d0b777a83ea.jpg
		...
		const ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 77777, status: 1, surface: 1, message: wm, orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
	 ...
	 message: { "liveLocationMessage": { "caption":"by : FaiRuzz +62","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./src/logo.jpg')}}
	}
